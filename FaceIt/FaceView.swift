...
//  FaceIt
//
//  Created by maisapride8 on 24/05/16.
...
class FaceView: UIView {
   ...
   private  var skullCenter:CGPoint {
    ...
    private func pathForCircleCentereAtPoint(midPoint: CGPoint, withRadius radius: CGFloat) -> UIBezierPath {
    ...
    /*private func pathForEye(eye: Eye) -> UIBezierPath {
        ...
        if eyesOpen{
            return pathForCircleCentereAtPoint(eyeCenter, withRadius: eyeRadius)
        } else {
            let path = UIBezierPath()
    ...
    private func pathForMouth() -> UIBezierPath {
        ...
        let mouthHeigth = skullRadius / Ratios.SkullRadiusToMouthHeight
    ...
    override func drawRect(rect: CGRect) {
        ...
        color.set()
        pathForCircleCentereAtPoint(skullCenter, withRadius: skullRadius).stroke()
